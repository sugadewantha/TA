...
<head>
  ...
  <link href="<?php echo base_url('assets/css/zabuto_calendar.css'); ?>" rel="stylesheet" type="text/css"  media="all" />
  <link href="<?php echo base_url('assets/js/gritter/css/jquery.gritter.css'); ?>" rel="stylesheet" type="text/css"  media="all" />
  <!-- custom style -->
  ...
  <link href="<?php echo base_url('assets/js/chart-master/Chart.js'); ?>" rel="stylesheet" type="text/css"  media="all" />
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?php echo base_url()."index.php/adminController/dashboard"; ?>" class="logo"><b>Bimbo Admin</b></a>
            <!--logo end-->
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    <!-- settings start -->
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="<?php echo base_url()."index.php/adminController/dashboard"; ?>">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="<?php echo base_url()."index.php/adminController/dashboard"; ?>">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo base_url()."index.php/upload/index"; ?>">Banner Edit</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
              ...
              <div class="row">
                  ...
                  <!--  <div class="col-md-4 col-sm-4 mb">
                          <div class="white-panel pn">
                            ...
                            <div class="centered">
                                <img src="<?php echo base_url('assets/images/adm-img/product.png')?>" width="120">
                            </div>
                          </div>
                        </div> --><!-- /col-md-4 -->
                        ...
                        <!-- <div class="col-md-4 mb"> -->
                          ...
                          <!-- <div class="white-panel pn">
                            ...
                            <p><img src="<?php echo base_url('assets/images/adm-img/ui-zac.jpg')?>" class="img-circle" width="80"></p>
                            <p><b>Zac Snider</b></p>
                            <div class="row">
                              <div class="col-md-6">
      ...
      *********************************************************************************************************************************************************** -->                  
            ...
            <!--<h3>TEAM MEMBERS</h3>
                      ...
                      <div class="desc">
                        <div class="thumb">
                          <img class="img-circle" src="<?php echo base_url('assets/images/adm-img/ui-divya.jpg')?>" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                      ...
                      <div class="desc">
                        <div class="thumb">
                          <img class="img-circle" src="<?php echo base_url('assets/images/adm-img/ui-sherman.jpg')?>" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                      ...
                      <div class="desc">
                        <div class="thumb">
                          <img class="img-circle" src="<?php echo base_url('assets/images/adm-img/ui-danro.jpg')?>" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                      ...
                      <div class="desc">
                        <div class="thumb">
                          <img class="img-circle" src="<?php echo base_url('assets/images/adm-img//ui-zac.jpg')?>" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                      ...
                      <div class="desc">
                        <div class="thumb">
                          <img class="img-circle" src="<?php echo base_url('assets/images/adm-img/ui-sam.jpg')?>" width="35px" height="35px" align="">
                        </div>
                        <div class="details">
...
<!-- END WRAP EM ALL -->
  ...
  <script src="<?php echo base_url('assets/js/zabuto_calendar.js'); ?>" type="text/javascript" ></script>
