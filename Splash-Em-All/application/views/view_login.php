  ...
  <!-- <div class="login-form"> -->
    ...
    <div class="login-square">
        <div class="row login-wrapper">
          ...
          <h1>
            <!-- <img src="<?php echo base_url('assets/images/bimbo-logo-cartoon.png')?>" alt="logo"> -->
          </h1>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">  
                ...
                <?php echo form_open(); ?>  
                  ...
                  <!-- <li><a href="<?php echo base_url()."index.php/masterController/dashboard"; ?>">Login here</a></li> -->
